    ...
    <v-row>
      ...
      <v-col cols="6">
        ...
        <v-card elevation="1">
          <v-row>
            <v-col class="ml-8">
              <v-btn icon @click.stop="like(DetailInfo.cd,DetailInfo.love)"
          ...
          <v-card-text>
            ...
            <div class="body-1" align="right">가격 :
              {{ String(Number(DetailInfo.salesPri) * ((100 - Number(DetailInfo.discountRate)) / 100)).comma() }} 원
            </div>
